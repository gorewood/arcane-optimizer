 ...
 * Each section is collapsible via accordion.
 */
  ...
  return (
    <div className="p-4">
      ...
      <Accordion type="multiple" defaultValue={["quick-start"]} className="space-y-2">
        ...
        <HelpAccordionItem value="goals" title="Understanding Goals">
          <GoalsContent />
        </HelpAccordionItem>

        <HelpAccordionItem value="weights" title="How Weights Work">
          <WeightsContent />
        </HelpAccordionItem>

        <HelpAccordionItem value="constraint-types" title="Constraint Types">
          <ConstraintTypesContent />
        </HelpAccordionItem>

        <HelpAccordionItem value="tips" title="Tips">
          <TipsContent />
        </HelpAccordionItem>

        <HelpAccordionItem value="algorithms" title="Search Algorithms">
          <SearchAlgorithmsContent />
        </HelpAccordionItem>

        <HelpAccordionItem value="scoring" title="How Scoring Works">
          <ScoringDetailsContent />
        </HelpAccordionItem>

        <HelpAccordionItem value="gear-inventory" title="Gear Inventory">
          <GearInventoryContent />
        </HelpAccordionItem>

        <HelpAccordionItem value="game-data" title="Game Data">
          <GameDataContent />
        </HelpAccordionItem>

        <HelpAccordionItem value="credits" title="Credits & Attribution">
          <CreditsContent />
        </HelpAccordionItem>
      </Accordion>
    </div>
...
function HelpAccordionItem({
  ...
  return (
    <AccordionItem
      value={value}
      className="border border-border-default rounded-md bg-bg-surface overflow-hidden"
    >
      <AccordionTrigger className="px-4 py-3 hover:no-underline hover:bg-bg-elevated text-accent-gold font-semibold">
        {title}
      </AccordionTrigger>
...
function QuickStartContent(): React.JSX.Element {
  return (
...
function GearInventoryContent(): React.JSX.Element {
  return (
    <>
...
function GameDataContent(): React.JSX.Element {
  return (
    <>
      <p className="text-text-secondary mb-3">
...
function WeightsContent(): React.JSX.Element {
  return (
    <>
      <p className="text-text-secondary mb-3">
...
function ConstraintTypesContent(): React.JSX.Element {
  return (
...
function SearchAlgorithmsContent(): React.JSX.Element {
  return (
      ...
      <div>
        ...
        <div className="mt-2 text-sm text-text-secondary">
          ...
          <ul className="list-disc list-inside ml-2">
            <li><strong>Islands</strong> — Parallel populations that evolve independently then share migrants.</li>
            <li><strong>Pop</strong> — Population size per island. Larger = more diversity, slower.</li>
...
function ScoringDetailsContent(): React.JSX.Element {
  return (
    <>
      <p className="text-text-secondary mb-3">
...
function TipsContent(): React.JSX.Element {
  return (
...
function CreditsContent(): React.JSX.Element {
  return (
    <>
      <p className="text-text-secondary mb-3">
